library(tidyverse)
censo_escolas <- read_delim("data/microdados_educacao_basica_2019/microdados_educacao_basica_2019/DADOS/ESCOLAS.CSV", delim = "|")
censo_escolas <- censo_escolas %>% filter(CO_UF == 35)

censo_turmas <- read_delim("data/microdados_educacao_basica_2019/microdados_educacao_basica_2019/DADOS/TURMAS.CSV", delim = "|")
