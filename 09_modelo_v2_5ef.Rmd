...
```{r}
set.seed(231192)
model <- train(media ~ nivel_socio_economico + ipvs567_ipvs + pilar_familia + pilar_letramento + pilar_regiao + pilar_localizacao + pilar_bens + I(tx_resp_q017e_A^2) + sqrt(tx_resp_q002_A) + q23_D_spp * q23_E_spp,
                        data = df,
                        method = "rpart",
                        metric = "Rsquared",
                        trControl = trControl)
...
```{r lm}
set.seed(231192)
model_lm <- train(media ~ nivel_socio_economico + ipvs567_ipvs + pilar_familia + pilar_letramento + pilar_regiao + pilar_localizacao + pilar_bens + I(tx_resp_q017e_A^2) + sqrt(tx_resp_q002_A) + q23_D_spp * q23_E_spp,
                        data = df,
                        method = "lm",
                        metric = "Rsquared",
                        trControl = trControl)
