...
```{r com novos pilares}
set.seed(231192)
model_v2 <- train(media ~ nivel_socio_economico + pilar_familia + tx_resp_q004_E+tx_resp_q005_E + tx_resp_q004_F + tx_resp_q005_F + pilar_regiao + pilar_localizacao + pilar_bens_superfluos +  pilar_bens_comodos  + I(tx_resp_q017e_A^2) + tx_resp_q002_A + q23_D_spp,
                        data = df3,
                        method = "lm",
                        metric = "Rsquared",
                        trControl = trControl)
