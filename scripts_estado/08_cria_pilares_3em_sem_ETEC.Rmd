...
df <-  df %>% 
  mutate(pred_letramento = round(predict(rpart_letramento, df)),
         pilar_letramento = case_when(
           pred_letramento >= 297 ~ 'A',
           pred_letramento >= 287 ~ 'B',
           pred_letramento >= 280 ~ 'C',
           pred_letramento >= 275 ~ 'D',
           pred_letramento >= 268 ~ 'E'
         ))
...
df <-  df %>% 
  mutate(pred_localizacao = round(predict(rpart_localizacao, df)),
         pilar_localizacao = case_when(
           pred_localizacao >= 298 ~ 'A',
           pred_localizacao >= 286 ~ 'B',
           pred_localizacao >= 279 ~ 'C',
           pred_localizacao >= 275 ~ 'D',
           pred_localizacao >= 269 ~ 'E'
